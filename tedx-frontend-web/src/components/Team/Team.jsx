...
function Team() {
  ...
  return (
    <div className="bg-black text-white flex flex-col items-center justify-around w-full md:px-52 px-20 ">
      ...
      <div className="flex flex-col md:flex-row md:w-3/4 justify-around items-center ">
        <Member imgURL={Aman} name="Aman Anand" className="mx-4" />
        <Member imgURL={Ria} name="Ria Arun"  className="mx-4"/>
      </div>
      <div className="mt-4 text-pm flex-wrap text-xl ">Associate Event Directors</div>
      ...
      <div className="flex w-full flex-wrap justify-around items-center mt-4 ">
        ...
        <Member imgURL={Shrujal} name="Shrujal" title="Director of Marketing" className="mx-4" />
